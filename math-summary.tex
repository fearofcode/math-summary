...
summarize key definitions and theorems for reference.
...
The following is taken from Spivak's {\it Calculus} \cite{spivak} as well as other basic calculus/analysis texts like \cite{ross}.
...
rest of the result follows. $\blacksquare$
