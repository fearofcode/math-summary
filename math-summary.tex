...
The sum-of-digits criteria for divisibility of 3 and 9 does not work for arbitrary powers of $3$ the way we can test for divisibility by powers of 2; if $n$'s digits sum to a multiple of 27, it is not generally the case that $27|n$; consider 883 as a (counter) example; $883/27 \notin \mathbb{Z}$.
