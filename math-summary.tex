...
\begin{proof}
Pay attention to how this is proved, because math people fucking love stupid tricks like this that have zero basis in intuition and if you were to derive it on your own is almost surely from just trying things:

OK, we can write $x = (x + y) - y$ for all $y$.

So $|x| = | (x+y) - y) | \leq |x + y| + |y|$.
